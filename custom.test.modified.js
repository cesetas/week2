...
describe('Custom Tests', function () {
  ...
  it('[assignment] ii. Alice deposits 0.1 ETH in L1 -> Alice withdraws 0.08 ETH in L2 -> assert balances', async () => {
  ...
  it('[assignment] iii. Alice deposits 0.13 ETH in L1 -> Alice sends 0.06 ETH to Bop in L2 -> Bob withdraws all funds in L2 -> Alice withdraws all funds in L1 -> assert balances', async () => {
      // [assignment] complete code here
      const { tornadoPool, token, omniBridge } = await loadFixture(fixture)
      const aliceKeypair = new Keypair() // contains private and public keys
